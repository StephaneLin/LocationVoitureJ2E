...
@WebServlet("/connected/staff/manager/user_addition")
public class UserAdditionServlet extends GenericServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        templateEngine.process("connected/staff/manager/user_addition", context, resp.getWriter());
    }
